...
# Function to retrieve all reviews from all collections in MongoDB with weighted context
def fetch_all_reviews():
    ...
    for collection_name in collection_names:
        ...
        for review in reviews:
            ...
            review_content = (
                f"[Weight: {weight}] Center: {review['Counseling Center']}\n"
                f"Name: {review['Name']}\n"
                f"Rating: {review['Rating']}/5\n"
                f"Review Year: {review_year}\n"
